...
if(isset($_POST['cari'])){
    ...
    $historyPembayaran = mysqli_query($conn, "SELECT * FROM pembayaran
                         ...
                         WHERE nisn='$nisn'
                         ORDER BY tgl_bayar");
    $siswa = mysqli_fetch_assoc($biodataSiswa);
?>
    <!-- Kita tampilkan Biodata Siswa -->
        ...
        <table class="table table-hover table-dark" cellpadding="5">
            ...
            <tr>
                <td>Kelas</td>
                <td>:</td>
                <td><?= $siswa['nama_kelas'] . " | " . $siswa['jurusan']; ?></td>
            </tr>
        </table>
        ...
        <table class="table table-hover table-dark" cellpadding="5" cellspacing="0" >
            <tr>
                ...
                <td>Bulan  SPP | Nominal yang harus dibayar</td>
...
if($r_trx['jumlah_bayar'] == $r_trx['nominal']){ ?>
                ...
                <td>-</td>
<?php }elseif ($r_trx['jumlah_bayar'] >= $r_trx['nominal']){ ?> <td><font style="color: tomato; font-weight: bold;">Lebih</font></td>
