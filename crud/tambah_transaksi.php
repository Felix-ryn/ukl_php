...
// $nama=$r['nama'];
$tnominal=mysqli_query($conn, "SELECT spp.nominal FROM spp,siswa WHERE siswa.nama= '$siswa'");
   
    if ($nom = mysqli_fetch_array($tnominal)) ?> {
        
<?php } ?> value="<?php $tnominal ?>"></td>
...
<?php } ?>          </select></td>
            ...
            <tr>
                <td>Jumlah bayar</td>
                <td><input class="form-control" type="text" name="jumlah" placeholder="1000000"></td>
            </tr>
            <tr>
                <td colspan="2">
